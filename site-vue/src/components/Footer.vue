<template>
  <div class="page-section">
    ...
    <p>
      ...
      <router-link :to="{ name: isLoggedIn ? 'Dashboard' : 'Top' }">Top</router-link> | <router-link to="about">About</router-link><span v-if="!isLoggedIn"> | <router-link to="pricing">Pricing</router-link></span><span v-else> | <a href='#' @click="logout()">Logout</a></span>
    </p>
  </div>
</template>
